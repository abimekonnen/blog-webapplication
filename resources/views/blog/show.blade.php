...
@endsection
@section('header')
  <header class="header text-white h-fullscreen pb-80" style="background-image: url({{  asset($src = 'storage/'. str_replace('public/', '', $post->image)) }});" data-overlay="9">
...
@section('content')
        ...
        <main class="main-content">
            ...
            |‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒
            !-->
            <div class="section" id="section-content" style=" background-color: rgba(243, 242, 242, 0.979);">
              <div class="container">
                ...
                <div class="row">
                  <div class="col-lg-8 mx-auto">
                    ...
                    <div class="media-list">
                      ...
                      <div class="media">
                        <img class="avatar avatar-sm mr-4" src="{{  asset($src = 'storage/'. str_replace('public/', '', $post->image)) }}" alt="...">
